...
const Product = () => {
    return (
        <div>
            {/*product text*/}
            <div className='px-4 lg:px-24 max-w-screen-2xl mx-auto my-8' id='product'>
            ...
            <div className='px-4 lg:px-24 max-w-screen-2xl mx-auto bg-neutralSilver py-16' id="testimonial">
